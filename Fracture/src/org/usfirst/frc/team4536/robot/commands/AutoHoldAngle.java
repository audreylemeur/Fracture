...
public class AutoHoldAngle extends CommandBase {
	private double forwardThrottle, strafeThrottle, turnThrottle, dAng;

    public AutoHoldAngle(double desiredEndAngle, double desiredAngle, double throttle, double time) {
        requires(driveTrain);
        dAng = desiredAngle;
    }
